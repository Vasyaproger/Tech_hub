...
ALLOWED_HOSTS = ['localhost', '127.0.0.1']  # Добавлено для локальной разработки
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / "static",  # Папка для разработки (должна существовать: E:\tech-shop\backend\static)
]
